...
@NamedQueries({
    ...
    @NamedQuery(name="Area.finByNumber",query="select a from Area a where a.number LIKE :areaNumber"),
    @NamedQuery(name="Area.finCountAreasWithNumber",query="select count(a) from Area a where a.number LIKE :areaNumber"),
